...
(function() {
    ...
    function toggleColors(){
        ...
        if (localStorage.getItem("isLight") === 'true'){
            ...
            if (themeIconSun && themeIconMoon) {
                ...
                themeIconSun.style.transform = "scale(0.5) rotate(-90deg)";

                setTimeout(function(){
                    themeIconSun.style.display = "none";
                    themeIconMoon.style.display = "block";
                    themeIconMoon.style.opacity = "0";
                    themeIconMoon.style.transform = "scale(0.5) rotate(90deg)";

                    setTimeout(function(){
                        themeIconMoon.style.opacity = "1";
                        themeIconMoon.style.transform = "scale(1) rotate(0deg)";
                    }, 50);
                }, 150);
            }
            ...
            if (themeIconSun && themeIconMoon) {
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                        ...
                        themeIconSun.style.transform = "scale(1) rotate(0deg)";
                    }, 50);
                }, 150);
            }
    ...
    themeColorButton.addEventListener("click", toggleColors);
})();